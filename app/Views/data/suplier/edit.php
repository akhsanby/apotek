			        	...
			        	<form role="form" action="/suplier/update/<?= $suplier['kode_suplier']; ?>" method="post">
			                <div class="card-body">
			                	...
			                	<div class="row">
				                    ...
				                    <input type="text" name="nama_suplier" class="form-control" id="nama_suplier" class="form-control" value="<?= $suplier['nama_suplier'] ?>">
				                    </div>
			                	</div>
				                  ...
				                  <div class="form-group">
				                    ...
				                    <input type="text" name="kota" class="form-control" id="kota" value="<?= $suplier['kota'] ?>">
				                  </div>
				                  <div class="form-group">
				                    <label for="telp">Telp</label>
				                    <input type="text" name="telp" class="form-control" id="telp" value="<?= $suplier['telp'] ?>">
				                  </div>
			                </div>
